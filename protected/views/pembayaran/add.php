        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active">Pembayaran Pasien</li>
                </ol>
            </div>
        </div>
    </div><!-- /.container-fluid -->
...
<section class="content">
    ...
    <div class="card">
        ...
        <form action="<?= $baseUrl ?>/pembayaran/add_action" method="post" id="myForm">
            <input type="hidden" name="pendaftaran_id" value="<?= $pendaftaran_id ?>">
            <input type="hidden" name="pembayaran_id" value="<?= $pembayaran_id ?>">
            <input type="hidden" name="pembayaran_total" id="pembayaran_total" value="<?= $pembayaran_total ?>">
                ...
                <div class="row">
                	<div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <input type="number" name="pembayaran_pasien" id="pembayaran_pasien" class="form-control" required min="0" placeholder="0">
                        </div>
                    </div>
                	<div class="col-lg-6">
                        <div class="form-group">
                            <label>Kembalian</label>
                            <input type="number" name="pembayaran_kembali" id="pembayaran_kembali" class="form-control" min="0" placeholder="0" value="0" readonly>
                        </div>
                    </div>
                </div>
            </div>
