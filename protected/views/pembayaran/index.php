						...
						<tbody>
							<?php
                                $listStatus = array(
                                    ...
                                    '2' => '<span class="badge badge-info">Menunggu<br>Pembayaran</span>',
                                    '3' => '<span class="badge badge-success">Selesai</span>'
                                );
                                $listPembayaranStatus = array(
                                    '0' => '<span class="badge badge-danger">Belum Lunas</span>',
								...
								foreach ($pembayaran as $data) {
									...
									$pembayaran_status         = trim($data['pembayaran_status']);

                                    if ($pendaftaran_status == 2 && $pembayaran_status == 0) {
                                        $addBtn = '<a href="'. $baseUrl .'/pembayaran/add/'. $pendaftaran_id .'" class="btn btn-sm btn-primary"><i class="fa fa-plus"></i></a>';
                                    } else {
                                        $addBtn = '<a href="'. $baseUrl .'/pembayaran/view/'. $pendaftaran_id .'" class="btn btn-sm btn-info" data-toggle="tooltip" title="Lihat"><i class="fa fa-eye"></i></a>';
                                    }
									...
									echo '
										<tr>
											...
											<td align="center">'. $listPembayaranStatus[$pembayaran_status] .'</td>
                                            <td align="center">
                                                '. $addBtn .'
                                            </td>
										</tr>
