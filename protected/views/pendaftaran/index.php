        ...
        <div class="card-body">
            <div class="row">
            	<div class="col-lg-12" align="right">
					<a href="<?= $baseUrl ?>/pendaftaran/add" class="btn btn-primary"><i class="fa fa-plus"></i> Tambah Pendaftaran</a>
					<hr>
				</div>
			</div>
            <div class="row">
								...
								foreach ($pendaftaran as $data) {
									...
									echo '
										<tr>
											...
											<td>'. $listStatus[$pendaftaran_status] .'</td>
                                            <!-- <td align="center">
                                                <a href="'. $baseUrl .'/pendaftaran/edit/'. $pendaftaran_id .'" class="btn btn-sm btn-warning" data-toggle="tooltip" title="Edit"><i class="fa fa-edit"></i></a>
                                            </td> -->
										</tr>
									';
								}
