        ...
        <form action="<?= $baseUrl ?>/tindakanobat/add_action" method="post" id="myForm">
            ...
            <div class="card-body">
            	...
            	<div class="row">
                            	...
                            	<div class="row">
                                	<div class="col-lg-8">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control obat_id" name="obat_id[]">
                                	...
                                	<div class="col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="obat_jumlah[]" class="form-control obat_jumlah" placeholder="0" min="1">
                                        </div>
                                	</div>
                                	<div class="col-lg-12" align="right">
                	...
                	<div class="col-lg-12">
                        <button type="button" class="btn btn-success" id="btn_tambah_obat" style="width: 100%;"><i class="fa fa-plus"></i> Edit Obat</button>
                    </div>
                </div>
            </div>
