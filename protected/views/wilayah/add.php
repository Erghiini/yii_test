...
<section class="content">
    ...
    <div class="card">
        ...
        <form action="<?= $baseUrl ?>/wilayah/add_action" method="post" id="myForm">
            <div class="card-body">
                <div class="row">
                ...
                <div class="row" style="justify-content: center;">
                	<div class="col-lg-4">
                        <div class="form-group">
                            ...
                            <input type="text" name="wilayah_nama" placeholder="Contoh: PASTEUR" class="form-control" maxlength="50" required>
                        </div>
                	</div>
                </div>
            </div>
